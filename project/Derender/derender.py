...
class Derender(nn.Module):
    ...
    def forward(self, image):
        ...
        # recon_image = 2. * recon_image - 1.

        # from [-1.0, 1.0] to [0.0, 1.0]
        recon_normal = (recon_normal + 1.0)/2.0
        recon_albedo = (recon_albedo + 1.0)/2.0

        return recon_depth, recon_normal, recon_albedo, recon_diffuse_shading, recon_specular_shading, recon_image
